...
from models.search import (
    ...
    SearchResult, SearchType, SimilarityMetric, SearchAnalytics
)
...
class SemanticSearchService:
    ...
    async def search(self, request: SemanticSearchRequest) -> SemanticSearchResponse:
        ...
        try:
            ...
            logger.debug(
                ...
                f"results={len(semantic_results)}, time={total_time:.1f}ms"
            )
    ...
    async def find_similar_documents(
        ...
        try:
            ...
            reference_embeddings = await self.vector_store.get_embeddings_by_document(
        ...
        return {
            **cache_stats,
            ...
            "average_similarity_score": (
                round(sum(avg_similarity_scores) / len(avg_similarity_scores), 3)
                if avg_similarity_scores else 0.0
            ),
