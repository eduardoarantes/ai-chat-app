...
class TestVectorStore:
    ...
    def sample_embeddings(self) -> List[ChunkEmbedding]:
        ...
        embeddings = []
        for i in range(3):
            metadata = EmbeddingMetadata(model_name="test-model", dimension=384, generation_time=0.1)
            embeddings.append(
                ChunkEmbedding(
                    chunk_id=f"chunk_{i}",
    ...
    class TestInitialization:
        ...
        async def test_custom_configuration(self, temp_db_path):
            ...
            with patch("core.vector_store.chromadb.PersistentClient") as mock_client_class:
                ...
                store = VectorStore(persistence_path=temp_db_path, collection_prefix="custom", enable_backup=False)
                await store.initialize()
    ...
    class TestCollectionManagement:
        ...
        async def test_create_collection_with_metadata(self, vector_store, mock_chroma_client):
            ...
            await vector_store._get_or_create_collection("test_session", metadata={"created_by": "test"})
        ...
        async def test_list_collections(self, vector_store, mock_chroma_client):
            ...
            mock_client, mock_collection = mock_chroma_client
            mock_client.list_collections.return_value = [Mock(name="documents_session1"), Mock(name="documents_session2")]
    ...
    class TestVectorOperations:
        ...
        async def test_store_embeddings_with_progress(self, vector_store, sample_embeddings, mock_chroma_client):
            ...
            await vector_store.store_embeddings(sample_embeddings, "test_session", progress_callback=progress_callback)
        ...
        async def test_retrieve_embedding_by_id(self, vector_store, mock_chroma_client):
            ...
            mock_collection.get.return_value = {
                "ids": ["chunk_1"],
                "embeddings": [[0.1] * 384],
                "metadatas": [{"document_id": "doc_1", "session_id": "test_session", "content_hash": "hash_1"}],
            }
    ...
    class TestSimilaritySearch:
        ...
        async def test_similarity_search_basic(self, vector_store, mock_chroma_client):
            ...
            results = await vector_store.similarity_search(query_vector, "test_session", limit=10)
        ...
        async def test_similarity_search_with_filters(self, vector_store, mock_chroma_client):
            ...
            results = await vector_store.similarity_search(query_vector, "test_session", filters=filters)
        ...
        async def test_similarity_search_threshold(self, vector_store, mock_chroma_client):
            ...
            results = await vector_store.similarity_search(query_vector, "test_session", min_similarity=0.6)
        ...
        async def test_similarity_search_empty_results(self, vector_store, mock_chroma_client):
            ...
            mock_collection.query.return_value = {"ids": [[]], "distances": [[]], "embeddings": [[]], "metadatas": [[]]}
    ...
    class TestUpdateAndDelete:
        ...
        async def test_update_embedding(self, vector_store, sample_embeddings, mock_chroma_client):
            ...
            result = await vector_store.update_embedding(embedding.chunk_id, "test_session", new_vector)
    ...
    class TestPerformance:
        ...
        async def test_concurrent_operations(self, vector_store, sample_embeddings, mock_chroma_client):
            ...
            tasks = [vector_store.store_embedding(embedding) for embedding in sample_embeddings]
