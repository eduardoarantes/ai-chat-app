...
from models.search import (
    ...
    SearchResult, SearchType, SimilarityMetric
)
...
class TestSemanticSearchService:
    ...
    class TestResultRanking:
        ...
        async def test_result_ranking_by_similarity(
            self,
            semantic_search_service,
            mock_embedding_service,
            mock_vector_store
        ...
        async def test_boost_recent_documents(
            self,
            semantic_search_service,
            mock_embedding_service,
            mock_vector_store
            ...
            results_with_timestamps = [
                SearchResult("c1", "d1", "s1", "old content", 0.8, 
                           {"created_at": "2023-01-01T00:00:00Z"}),
                SearchResult("c2", "d2", "s1", "recent content", 0.7,
    ...
    class TestSimilarDocuments:
        ...
        async def test_find_similar_documents_empty_reference(
            self,
            semantic_search_service,
            mock_vector_store
        ):
            ...
            with pytest.raises(SemanticSearchError, match="No embeddings found"):
                await semantic_search_service.find_similar_documents(
