...
from core.cleanup_manager import CleanupPolicy, SessionCleanupManager
from core.document_store import DocumentStore
from core.session_document_manager import SessionDocumentManager
from models.session import DocumentMetadata, DocumentProcessingStatus, EnhancedSession, SessionDocument
...
class TestSessionCleanupManager:
    ...
    def create_test_cleanup_manager(self, config=None):
        ...
        return SessionCleanupManager(
            session_manager=session_manager, document_store=document_store, access_controller=access_controller, config=config
        )
    ...
    def test_cleanup_orphaned_documents(self):
        ...
        doc2 = DocumentMetadata(
            ...
            size=1024,
            uploaded_at=now,
            last_accessed=now - timedelta(hours=96),  # Old enough to be cleaned
        )
    ...
    def test_validate_cleanup_policy(self):
        ...
        valid_config = {"session_ttl_hours": 24, "document_ttl_hours": 72, "cleanup_interval_minutes": 60}
