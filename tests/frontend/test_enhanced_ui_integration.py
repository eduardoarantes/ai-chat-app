...
class TestEnhancedUIIntegration:
    ...
    def setup_method(self):
        ...
        self.error_result = {
            ...
            "suggested_actions": ["Choose a smaller file", "Compress the file before uploading"],
            "recoverable": False,
        }
    ...
    def test_complete_file_processing_workflow(self):
        ...
        expected_validation_calls = [
            call(25, "file_size_check"),
            call(50, "mime_type_validation"),
            call(75, "security_scan"),
            call(100, "content_validation"),
        ]
        ...
        assert (
            self.mock_enhanced_ui.startProcessing.call_count == 1
        )  # Called manually (validation completion would call it automatically in real implementation)
