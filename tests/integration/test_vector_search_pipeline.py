...
from models.search import (
    SemanticSearchRequest, ChunkEmbedding, EmbeddingMetadata,
...
class TestVectorSearchPipeline:
    ...
    class TestEndToEndPipeline:
        ...
        async def test_document_processing_to_search(
            self, 
            vector_services, 
        ...
        async def test_search_performance_and_caching(
            self,
            vector_services
        ):
    ...
    class TestPerformanceAndScaling:
        ...
        async def test_concurrent_search_operations(
            ...
            with patch.object(semantic_search_service, 'search') as mock_search:
                ...
                tasks = [
                    semantic_search_service.search(request)
