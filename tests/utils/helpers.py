...
class FileUploadHelper:
    ...
    def create_multipart_data(
        session_id: str, prompt: str, file_content: bytes, filename: str, content_type: str
    ) -> Dict[str, Any]:
        """
        ...
        """
        return {"session_id": session_id, "prompt": prompt, "file": (filename, file_content, content_type)}

    @staticmethod
    def create_httpx_files_data(file_content: bytes, filename: str, content_type: str) -> Dict[str, Any]:
        """
        ...
        """
        return {"file": (filename, file_content, content_type)}
...
class AsyncTestHelper:
    ...
    @staticmethod
    async def consume_async_generator(async_gen: AsyncGenerator[Any, None]) -> List[Any]:
        """
    ...
    @staticmethod
    async def wait_for_condition(condition_func, timeout: float = 5.0, poll_interval: float = 0.1) -> bool:
        """
