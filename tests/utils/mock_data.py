...
class MockDataGenerator:
    ...
    @staticmethod
    def generate_conversation(num_exchanges: int = 3, include_multimodal: bool = False) -> List[Dict[str, Any]]:
        """
    ...
    def generate_session(
        session_id: Optional[str] = None, title: Optional[str] = None, num_messages: int = 6
    ) -> Dict[str, Any]:
        """
    ...
    def generate_error_scenarios() -> List[Dict[str, Any]]:
        ...
        """
        return [
            {"scenario": "missing_session_id", "data": {"prompt": "Hello"}, "expected_error": "Session ID is required"},
            {
            ...
            {
                "scenario": "large_file",
                "data": {"session_id": "test-123", "prompt": "Process this file", "file_size": 50 * 1024 * 1024},  # 50MB
