...
def create_app() -> FastAPI:
    ...
    if config.enable_vector_search:
        ...
        async def init_vector_services():
            ...
            if session_document_manager:
                initialize_vector_services(embedding_service, vector_store, semantic_search_service, session_document_manager)
    ...
    logging.info(
        f"Configuration: max_file_size={config.max_file_size}, security_scanning={config.enable_security_scanning}, vector_search={config.enable_vector_search}"
    )
